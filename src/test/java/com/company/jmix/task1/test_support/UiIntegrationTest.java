package com.company.jmix.task1.test_support;

import com.company.jmix.task1.JmixTask1Application;
 ...
 */
@SpringBootTest
@UiTest(authenticatedUser = "admin", mainScreenId = "MainScreen", screenBasePackages = "com.company.jmix.task1.screen")
@ContextConfiguration(classes = {JmixTask1Application.class, UiTestAssistConfiguration.class})
